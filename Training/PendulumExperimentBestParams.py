...
params['data_train_len'] = 6
params['len_time'] = 51
n = 2  # dimension of system (and input layer)
num_initial_conditions = 10000  # per training file
params['delta_t'] = 0.01

# settings related to saving results
params['folder_name'] = 'TrainedNetwork'
...
params['max_time'] = 8 * 60 * 60  # 6 hours
params['min_5min'] = .25 * 100
params['min_20min'] = .02 * 100
params['min_40min'] = .002 * 100
params['min_1hr'] = .0002 * 100
params['min_2hr'] = .00002 * 100
params['min_3hr'] = .000004 * 100
params['min_4hr'] = .0000005 * 100
params['min_halfway'] = 1
params['relative_loss'] = True
